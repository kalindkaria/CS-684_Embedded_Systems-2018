...
uint8_t detectKeyPress()
{
    ...
    if (!(GPIOPinRead(GPIO_PORTF_BASE, GPIO_PIN_0)) && idle == 1)
    {
    ...
    else if ((GPIOPinRead(GPIO_PORTF_BASE, GPIO_PIN_0)) && press == 1)
    {
    ...
    else if ((GPIOPinRead(GPIO_PORTF_BASE, GPIO_PIN_0)) && release == 1)
    {
